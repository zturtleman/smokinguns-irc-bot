...
sub on_public {
	...
	} elsif($lcmsg eq 'red neckerson' || $lcmsg =~ /smokin\'?\ ?\guns/) {
		my @redMessages = ('Pat all the Smokin Guns on the back for a job well done.', 'Red wears pink cowboy boots! o_O', 'Thanks to ALL the Smokin Guns!!! Hats off fellas.');
